...
We take the security of MATI seriously. If you discover a vulnerability, we ask that you report it to us **responsibly and confidentially**. Please **do not** create a public GitHub issue for security-related matters.
...
* **Affected versions:** Specify which version of MATI you found the vulnerability in.
...
We accept vulnerability reports for the following versions of MATI:
